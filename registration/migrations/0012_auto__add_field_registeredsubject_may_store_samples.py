...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.may_store_samples'
        db.add_column('bhp_registration_registeredsubject', 'may_store_samples', self.gf('django.db.models.fields.CharField')(default='?', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.may_store_samples'
        db.delete_column('bhp_registration_registeredsubject', 'may_store_samples')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 9, 3)'}),
