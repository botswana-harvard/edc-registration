...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.identity'
        db.add_column('bhp_registration_registeredsubject', 'identity', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.identity'
        db.delete_column('bhp_registration_registeredsubject', 'identity')
