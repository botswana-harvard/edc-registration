...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.survival_status'
        db.add_column('bhp_registration_registeredsubject', 'survival_status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Adding field 'RegisteredSubjectAudit.survival_status'
        db.add_column('bhp_registration_registeredsubject_audit', 'survival_status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.survival_status'
        db.delete_column('bhp_registration_registeredsubject', 'survival_status')

        # Deleting field 'RegisteredSubjectAudit.survival_status'
        db.delete_column('bhp_registration_registeredsubject_audit', 'survival_status')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 1, 30)'}),
