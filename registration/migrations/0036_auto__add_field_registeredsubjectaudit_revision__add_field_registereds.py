...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisteredSubjectAudit.revision'
        db.add_column('bhp_registration_registeredsubject_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegisteredSubject.revision'
        db.add_column('bhp_registration_registeredsubject', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisteredSubjectAudit.revision'
        db.delete_column('bhp_registration_registeredsubject_audit', 'revision')

        # Deleting field 'RegisteredSubject.revision'
        db.delete_column('bhp_registration_registeredsubject', 'revision')
    ...
    models = {
        ...
        'registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
