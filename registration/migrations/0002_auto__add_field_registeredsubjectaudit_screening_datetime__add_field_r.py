...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisteredSubjectAudit.screening_datetime'
        db.add_column('bhp_registration_registeredsubject_audit', 'screening_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegisteredSubjectAudit.screening_age_in_years'
        db.add_column('bhp_registration_registeredsubject_audit', 'screening_age_in_years',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegisteredSubject.screening_datetime'
        db.add_column('bhp_registration_registeredsubject', 'screening_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegisteredSubject.screening_age_in_years'
        db.add_column('bhp_registration_registeredsubject', 'screening_age_in_years',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisteredSubjectAudit.screening_datetime'
        db.delete_column('bhp_registration_registeredsubject_audit', 'screening_datetime')

        # Deleting field 'RegisteredSubjectAudit.screening_age_in_years'
        db.delete_column('bhp_registration_registeredsubject_audit', 'screening_age_in_years')

        # Deleting field 'RegisteredSubject.screening_datetime'
        db.delete_column('bhp_registration_registeredsubject', 'screening_datetime')

        # Deleting field 'RegisteredSubject.screening_age_in_years'
        db.delete_column('bhp_registration_registeredsubject', 'screening_age_in_years')
