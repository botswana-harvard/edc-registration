...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'OffStudy.off_study_date'
        db.rename_column('bhp_registration_offstudy', 'off_study_date', 'date_off_study' )

    def backwards(self, orm):
        
        # Rename field 'OffStudy.date_off_study'
        db.rename_column('bhp_registration_offstudy', 'date_off_study', 'off_study_date')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 5, 12)'}),
