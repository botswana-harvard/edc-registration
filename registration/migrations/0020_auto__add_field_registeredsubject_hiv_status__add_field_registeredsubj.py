...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.hiv_status'
        db.add_column('bhp_registration_registeredsubject', 'hiv_status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Adding field 'RegisteredSubjectAudit.hiv_status'
        db.add_column('bhp_registration_registeredsubject_audit', 'hiv_status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.hiv_status'
        db.delete_column('bhp_registration_registeredsubject', 'hiv_status')

        # Deleting field 'RegisteredSubjectAudit.hiv_status'
        db.delete_column('bhp_registration_registeredsubject_audit', 'hiv_status')
