...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegisteredSubject.registration_identifier'
        db.alter_column('bhp_registration_registeredsubject', 'registration_identifier', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))


    def backwards(self, orm):
        
        # Changing field 'RegisteredSubject.registration_identifier'
        db.alter_column('bhp_registration_registeredsubject', 'registration_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
