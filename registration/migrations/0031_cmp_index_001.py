...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_index('bhp_registration_registeredsubject', ['subject_identifier', 'subject_type', 'relative_identifier', 'registration_datetime'])
        db.create_index('bhp_registration_registeredsubject', ['subject_identifier', 'subject_type', 'relative_identifier', 'registration_datetime', 'registration_identifier'], unique=False)
    ...
    models = {
        ...
        'bhp_registration.registeredsubjectaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RegisteredSubjectAudit', 'db_table': "u'bhp_registration_registeredsubject_audit'"},
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 19, 0, 0)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
