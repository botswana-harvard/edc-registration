...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.registration_identifier'
        db.add_column('bhp_registration_registeredsubject', 'registration_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.registration_identifier'
        db.delete_column('bhp_registration_registeredsubject', 'registration_identifier')
