...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.dob'
        db.add_column('bhp_registration_registeredsubject', 'dob', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'RegisteredSubject.is_dob_estimated'
        db.add_column('bhp_registration_registeredsubject', 'is_dob_estimated', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.dob'
        db.delete_column('bhp_registration_registeredsubject', 'dob')

        # Deleting field 'RegisteredSubject.is_dob_estimated'
        db.delete_column('bhp_registration_registeredsubject', 'is_dob_estimated')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 8, 25)'}),
