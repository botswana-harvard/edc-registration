...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.study_site'
        db.add_column('bhp_registration_registeredsubject', 'study_site', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_variables.StudySite']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.study_site'
        db.delete_column('bhp_registration_registeredsubject', 'study_site_id')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 9, 13)'}),
