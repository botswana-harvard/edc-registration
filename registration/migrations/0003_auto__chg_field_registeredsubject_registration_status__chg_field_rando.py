...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegisteredSubject.registration_status'
        db.alter_column('bhp_registration_registeredsubject', 'registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'RandomizedSubject.registration_status'
        db.alter_column('bhp_registration_randomizedsubject', 'registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'RegisteredSubject.registration_status'
        db.alter_column('bhp_registration_registeredsubject', 'registration_status', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'RandomizedSubject.registration_status'
        db.alter_column('bhp_registration_randomizedsubject', 'registration_status', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))


    models = {
        'bhp_registration.offstudy': {
            'Meta': {'object_name': 'OffStudy'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_off_study': ('django.db.models.fields.DateField', [], {}),
            ...
            'reason_off_study': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.OffStudyReason']"}),
            'reason_off_study_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
        ...
        'bhp_registration.offstudyreason': {
            'Meta': {'ordering': "['display_index']", 'object_name': 'OffStudyReason'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 6, 8)'}),
