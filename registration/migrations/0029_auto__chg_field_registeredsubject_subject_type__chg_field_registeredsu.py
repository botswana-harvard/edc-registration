...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegisteredSubject.subject_type'
        db.alter_column('bhp_registration_registeredsubject', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'RegisteredSubjectAudit.subject_type'
        db.alter_column('bhp_registration_registeredsubject_audit', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'RegisteredSubject.subject_type'
        db.alter_column('bhp_registration_registeredsubject', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'RegisteredSubjectAudit.subject_type'
        db.alter_column('bhp_registration_registeredsubject_audit', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 0, 0)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'honeypot'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'honeypot'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
