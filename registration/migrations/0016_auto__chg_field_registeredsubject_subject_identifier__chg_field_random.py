...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bhp_registration_registeredsubject', 'subject_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36))

        # Changing field 'RandomizedSubject.subject_identifier'
        db.alter_column('bhp_registration_randomizedsubject', 'subject_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36))


    def backwards(self, orm):
        
        # Changing field 'RegisteredSubject.subject_identifier'
        db.alter_column('bhp_registration_registeredsubject', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))

        # Changing field 'RandomizedSubject.subject_identifier'
        db.alter_column('bhp_registration_randomizedsubject', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
    ...
    models = {
        'bhp_registration.randomizedsubject': {
            ...
            'subject_identifier': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36'}),
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 10, 19)'}),
