...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'RegisteredSubject', fields ['subject_identifier']
        db.create_index('bhp_registration_registeredsubject', ['subject_identifier'])

        # Adding index on 'RandomizedSubject', fields ['subject_identifier']
        db.create_index('bhp_registration_randomizedsubject', ['subject_identifier'])


    def backwards(self, orm):
        
        # Removing index on 'RandomizedSubject', fields ['subject_identifier']
        db.delete_index('bhp_registration_randomizedsubject', ['subject_identifier'])

        # Removing index on 'RegisteredSubject', fields ['subject_identifier']
        db.delete_index('bhp_registration_registeredsubject', ['subject_identifier'])
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            ...
            'randomization_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'registration_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'registration_identifier': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'registration_status': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
