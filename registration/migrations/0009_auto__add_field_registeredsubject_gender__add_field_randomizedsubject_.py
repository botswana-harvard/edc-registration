...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredSubject.gender'
        db.add_column('bhp_registration_registeredsubject', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'RandomizedSubject.gender'
        db.add_column('bhp_registration_randomizedsubject', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredSubject.gender'
        db.delete_column('bhp_registration_registeredsubject', 'gender')

        # Deleting field 'RandomizedSubject.gender'
        db.delete_column('bhp_registration_randomizedsubject', 'gender')
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 8, 11)'}),
