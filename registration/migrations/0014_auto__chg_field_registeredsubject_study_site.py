...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegisteredSubject.study_site'
        db.alter_column('bhp_registration_registeredsubject', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_variables.StudySite'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RegisteredSubject.study_site'
        raise RuntimeError("Cannot reverse this migration. 'RegisteredSubject.study_site' and its values cannot be restored.")
    ...
    models = {
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2011, 9, 14)'}),
